#undef VRHELLOWORLD_API
#undef VRHELLOWORLD_VTABLE
...
#define UE_PROJECT_NAME vrHelloWorld
...
#define VRHELLOWORLD_VTABLE DLLEXPORT_VTABLE
#define VRHELLOWORLD_API DLLEXPORT
